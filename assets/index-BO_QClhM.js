...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}];function Pc({content:e}){const{name:t,email:i,body:n}=e;return O.jsxs("div",{className:"CommentInfo",children:[O.jsxs("div",{className:"CommentInfo__title",children:[O.jsx("strong",{className:"CommentInfo__name",children:t})," by ",O.jsx("a",{className:"CommentInfo__email",href:`mailto:${i}`,children:i})]}),O.jsx("div",{className:"CommentInfo__body",children:n})]})}const Lc=({comment:e})=>O.jsx("div",{className:"CommentList",children:e.map(t=>O.jsx(Pc,{content:t},t.id))});function Tc({userInfo:e}){const{name:t,email:i}=e;return O.jsx("a",{className:"UserInfo",href:`mailto:${i}`,children:t})}function Mc({data:e}){const{title:t,body:i,user:n,comment:a}=e;return O.jsxs("div",{className:"PostInfo",children:[O.jsxs("div",{className:"PostInfo__header",children:[O.jsx("h3",{className:"PostInfo__title",children:t}),O.jsxs("p",{children:[" Posted by  ",O.jsx(Tc,{userInfo:n})]})]}),O.jsxs("p",{className:"PostInfo__body",children:[" ",i," "]}),O.jsx("hr",{}),a.length>0?O.jsx(Lc,{comment:a}):O.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]})}const Dc=({data:e})=>O.jsx("div",{className:"PostList",children:O.jsx(Mc,{data:e})});function Rc(e){return zc.filter(t=>t.postId===e)||null}function jc(e){return Nc.find(t=>t.id===e)||null}const Oc=Cc.map(e=>({...e,comment:Rc(e.id),user:jc(e.userId)})),Fc=()=>O.jsxs("section",{className:"App",children:[O.jsx("h1",{className:"App__title",children:"Static list of posts"}),Oc.map(e=>O.jsx(Dc,{data:e},e.id))]});em(document.getElementById("root")).render(O.jsx(Fc,{}));
